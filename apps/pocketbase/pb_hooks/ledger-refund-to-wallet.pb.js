...
onRecordAfterCreateSuccess((e) => {
  // Only process REFUND ledger entries
  if (e.record.get("ledger_type") !== "REFUND") {
    e.next();
    return;
  }
  ...
  try {
    ...
    txnRecord.set("transaction_type", "refund");
    ...
    // Update wallet balance - add refund amount
    ...
    console.error("Error in ledger-refund-to-wallet hook: " + err.message);
    throw err;
  }
