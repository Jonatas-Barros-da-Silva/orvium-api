...
migrate((app) => {
  ...
  const record0 = new Record(collection);
    ...
    record0.set("description", "Sends a notification when a payout exceeds 5000");
  ...
  const record1 = new Record(collection);
    ...
    record1.set("description", "Alerts when wallet balance drops below 1000");
  ...
  const record2 = new Record(collection);
    ...
    record2.set("description", "Sends notification and triggers analytics when repasse completes");
    record2.set("category", "operations");
    record2.set("event_type", "event.repasse.completed");
    record2.set("conditions_json", "{}");
    record2.set("actions_json", [{"type": "send_notification", "channel": "internal"}, {"type": "trigger_integration", "adapter": "analytics"}]);
  ...
  const record3 = new Record(collection);
    ...
    record3.set("description", "Alerts and creates task for transactions exceeding 10000");
  ...
  const record4 = new Record(collection);
    ...
    record4.set("description", "Automatically syncs payout data to analytics platform");
    record4.set("category", "analytics");
    record4.set("event_type", "event.payout.sent");
    record4.set("conditions_json", "{}");
    record4.set("actions_json", [{"type": "trigger_integration", "adapter": "analytics"}]);
  ...
  const record5 = new Record(collection);
    ...
    record5.set("description", "Logs all ledger entries to analytics for audit trail");
    record5.set("category", "operations");
    record5.set("event_type", "event.ledger.entry.created");
    record5.set("conditions_json", "{}");
    record5.set("actions_json", [{"type": "trigger_integration", "adapter": "analytics"}]);
