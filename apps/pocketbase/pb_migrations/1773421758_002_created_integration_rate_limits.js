...
migrate((app) => {
  ...
  const collection = new Collection({
    ...
    "id": "pbc_7366908676",
    "indexes": ["CREATE UNIQUE INDEX idx_integration_rate_limits_workspace_integration_id ON integration_rate_limits (workspace_integration_id)"],
  ...
  try {
    const collection = app.findCollectionByNameOrId("pbc_7366908676");
