...
migrate((app) => {
  ...
  const event_typesCollection = app.findCollectionByNameOrId("event_types");
  ...
  const collection = new Collection({
    ...
    "fields":     [
          ...
          },
          {
                ...
                "type": "relation",
                "cascadeDelete": false,
                "collectionId": event_typesCollection.id,
                "displayFields": [],
                "maxSelect": 1,
                "minSelect": 0
          },
  ...
  try {
    const collection = app.findCollectionByNameOrId("pbc_6699069243");
